...
recipes.addShaped("Modular Controller", <modularmachinery:blockcontroller>, [[null, ingot, null], [<ore:blockRedstone>, <modularmachinery:blockcasing>, <ore:blockRedstone>], [<ore:ingotGold>, <projectred-transportation:routing_chip:3>, <ore:ingotGold>]]);
