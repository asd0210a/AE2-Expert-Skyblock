...
val thau={<thaumcraft:shimmerleaf>:<minecraft:red_flower>,<thaumcraft:cinderpearl>:<minecraft:yellow_flower>,<thaumcraft:vishroom>:<minecraft:red_mushroom>} as IItemStack[IItemStack];
