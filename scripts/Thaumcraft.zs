...
table.removeRecipe(<thaumcraft:smelter_void>);
table.registerShapedRecipe("Void Essentia Smeltery","ESSENTIASMELTERVOID", 750, [<aspect:ignis>*3],<thaumcraft:smelter_void>,
[[<thaumcraft:plate>, <thaumcraft:smelter_basic>, <thaumcraft:plate>],[voidplate, <thaumcraft:metal_alchemical_advanced>, voidplate], [voidplate, <thermalfoundation:material:295>, voidplate]]);


//Inculde TiC FurnaceC
recipes.remove(<tconstruct:seared_furnace_controller>);
table.removeRecipe(<thaumcraft:smelter_basic>);
...
//---------Gear Remove----------//
	...
	val craftgears=[<thaumcraft:thaumium_helm>,<thaumcraft:void_helm>,<thaumcraft:thaumium_legs>,<thaumcraft:void_legs>,<thaumcraft:thaumium_chest>,<thaumcraft:void_chest>,<thaumcraft:thaumium_boots>,<thaumcraft:void_boots>] as IItemStack[];
	for ct in craftgears{
		recipes.remove(ct);
	}

	val gears=[<thaumcraft:fortress_chest>,<thaumcraft:fortress_legs>,<thaumcraft:fortress_helm>] as IItemStack[];
	for t in gears{
